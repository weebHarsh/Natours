...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2VlYmhhcnNoIiwiYSI6ImNrZjZkYnM0dzBkbTkyeG96YTloamt4OTkifQ.z_9ZjNICf0QHvWnj-0VU4Q';
...
var stripe = Stripe('pk_test_51HToUIHqYCXBgBKes5AvG4GXrs2ICge2GNXmDIYqXrh1r61iZN37bg7ZR3hqkFPMI0leADPAWGxjgjTry8vuisOh00RuWF0aic');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout + charge the credit card
